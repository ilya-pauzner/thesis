...
sns.relplot(data=filtered_df, x="active", y="migr", style="algo", col="abs_task_type", row="shrink", s=100)
sns.relplot(data=filtered_df, x="host_count", y="time", style="algo", col="abs_task_type", row="shrink", s=100)
plt.show()
